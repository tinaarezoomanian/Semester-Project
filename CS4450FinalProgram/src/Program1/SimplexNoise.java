...
*
* purpose: The program is a compact Simplex Noise implementation in 2D.
...
public class SimplexNoise {
    ...
    // method - noise  
    // purpose - returns 2d simplex noise value based on input x and y  
    ...
    // method - fastfloor  
    // purpose - quickly returns the largest integer less than or equal to x  
    private static int fastfloor(float x) {
        return x > 0 ? (int)x : ((int)x - 1);
    }
    
    // method - dot  
    // purpose - computes dot product of gradient and position  
