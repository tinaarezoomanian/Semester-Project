...
/*
 * A compact Simplex Noise implementation in 2D.
 * This code is adapted from public domain sources (e.g., Stefan Gustavson's work).
 * It returns a value in the approximate range [-1, 1] for given x,y inputs.
 */
public class SimplexNoise {
    ...
    public static float noise(float xin, float yin) {
        ...
        float x0 = xin - X0;
        float y0 = yin - Y0;
        int i1, j1; // Offsets for second corner in (i,j)
        if (x0 > y0) {
            i1 = 1;
            j1 = 0;
        } else {
        ...
        // Scale to cover the range approximately [-1, 1]
