...
*   sets the skybox to a bright daytime environment with blue skies.
*
* - N: switch to night mode
*   sets the skybox to a darker night environment with starry textures.
*
* - H: toggle hell mode (press H again to turn off)
*   switches all terrain textures to lava and skybox to a fiery alien world.
*   disables day/night skyboxes while active. plays a hell mode audio cue.
***************************************************************/
